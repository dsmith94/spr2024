...
`;Game.rooms.title=()=>{header(""),check(()=>go("startRoom")),help("About this Game",()=>helpMsg),desc(()=>titleMsg)},window.addEventListener("keydown",function(e){-1<["Space","ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].indexOf(e.code)&&e.preventDefault()},!1),addEventListener("keyup",e=>{switch(e.key.toLocaleLowerCase()){case"l":return void set_game_action("look");case"u":return void set_game_action("use");case"t":return void set_game_action("talk");case"u":return void set_game_action("use");case"h":return void set_game_action("help");case"1":return void set_game_topic(1);case"2":return void set_game_topic(2);case"3":return void set_game_topic(3);case"4":return void set_game_topic(4);case"5":return void set_game_topic(5);case"6":return void set_game_topic(6);case"7":return void set_game_topic(7);case"8":return void set_game_topic(8);case"9":return void set_game_topic(9);case"enter":return void execute_action();case"backspace":return void backspace_action();case"a":case"arrowleft":return void set_game_action("west");case"d":case"arrowright":return void set_game_action("east");case"w":case"arrowup":return void set_game_action("north");case"s":case"arrowdown":return void set_game_action("south")}}),Game.rooms.nextRoom=()=>{header("Next Room"),desc(()=>'This is the <<next>> "room".'),look(showDesc),use("Next room",()=>"This is a test."),talk("Yell",()=>"AAAAHHHHHH! That feels better."),help("Hint Please",()=>"No hint for you."),north("Leave Room",()=>go("nextRoom"))};